This project is a Weather Web App that provides users with current weather information for a specific location. The application is implemented using HTML, CSS, and JavaScript.
